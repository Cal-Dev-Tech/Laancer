        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#job_search_by_text',function(){
                if ($('#job_search_string').val() == '') {
                    ...
                    $.ajax({
                        url:"{{ route('subcategory.jobs.filter')}}",
                        method:'GET',
                        data:{country:country,type:type,level:level,min_price:min_price,max_price:max_price,duration:duration,subcategory:subcategory,job_search_string:job_search_string},
            ...
            $(document).on('click', '.pagination a', function(e){
                ...
                jobs(page,country,subcategory,type,level,min_price,max_price,duration,job_search_string);
            });
            function jobs(page,country,subcategory,type,level,min_price,max_price,duration,job_search_string){
                $.ajax({
                    url:"{{ route('subcategory.jobs.pagination').'?page='}}" + page,
                    method:'GET',
                    data:{country:country,subcategory:subcategory,type:type,level:level,min_price:min_price,max_price:max_price,duration:duration,job_search_string:job_search_string},
                    success:function(res){
                        if(res.status=='nothing'){
            ...
            $(document).on('click', '#subcategory_job_filter_reset', function(e){
                ...
                let subcategory = $('#subcategory_id').val();
                $.ajax({
                    url:"{{ route('subcategory.jobs.filter.reset')}}",
                    method:'GET',
