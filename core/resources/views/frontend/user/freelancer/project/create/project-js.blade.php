    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $(document).on('change','.checkbox_or_numeric_select',function(){
                ...
                let variable_name = $(this).closest(".append-include").find(
                    '.checkbox_or_numeric_title').val().toLowerCase().replace(/[^a-z0-9_]/g, "_");
                ...
                currentRow.each(function (){
                    ...
                    if($('#offer_packages_available_or_not').val() != 1 && i > 1){
                        ...
                        textField = '<input type="text" name="'+ inputName +'" class="form-control disabled_or_not text-input" maxlength="60" placeholder="Enter text (max 60 chars)"><div class="char-counter">0/60</div>';
                    }else{
                    ...
                    let priceField = '<input type="number" name="'+ priceName +'" class="form-control price-input mt-1" placeholder="Extra price" min="0">';
                       ...
                       <th>
                        ...
                        <td>
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <input type="number" name="title[basic_price]" class="form-control price-input" placeholder="Extra price" min="0">
                                </div>
                        </td>
                        ...
                        <td>
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <input type="number" name="title[standard_price]" class="form-control price-input" placeholder="Extra price" min="0">
                                </div>
                        </td>
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                ...
                                <input type="number" name="title[premium_price]" class="form-control price-input" placeholder="Extra price" min="0">
