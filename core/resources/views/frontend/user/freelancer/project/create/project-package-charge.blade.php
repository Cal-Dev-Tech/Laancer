    ...
    <div class="create-project-wrapper-item">
        <div class="create-project-wrapper-item-top profile-border-bottom">
            ...
            <div class="custom_switch_wrapper d-flex align-items-center gap-2">
                <span>{{ __('Enable/Disable package') }}</span>
                    ...
                    <tr>
                        ...
                        <th class="package-head">
                            <div class="package-head-flex flex-between align-items-center">
                                <span class="package-head-title" id="basic_title" data-title="Basic">{{ __('Basic') }}</span>
                                <span class="package-head-edit"></span>
                            </div>
                        </th>
                        <th class="package-head">
                            <div class="package-head-flex flex-between align-items-center">
                                <span class="package-head-title" id="standard_title" data-title="Standard">{{ __('Standard') }}</span>
                                <span class="package-head-edit"></span>
                            </div>
                        </th>
                        <th class="package-head">
                            <div class="package-head-flex flex-between align-items-center">
                                <span class="package-head-title" id="premium_title" data-title="Premium">{{ __('Premium') }}</span>
                                <span class="package-head-edit"></span>
                            </div>
                        </th>
                    </tr>
                            ...
                            <div class="package-field">
                                <div class="package-select">
                                    <select class="form-control" name="basic_revision" id="basic_revision">
                                        ...
                                        @endfor
                                        <option value="1000">{{ __('Unlimited') }}</option>
                                    </select>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr class="append-include">
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                ...
                                <input name="title[basic_price]" type="number" class="form-control price-input" placeholder="Extra price" min="0">
                            </div>
                        </td>
                        <td>
                            <div class="d-flex flex-column gap-1">
                                <input name="title[standard]" type="checkbox" class="check-input disabled_or_not" value="on" checked>
                                <input name="title[standard_price]" type="number" class="form-control price-input" placeholder="Extra price" min="0">
                            </div>
                        </td>
                        <td>
                            <div class="d-flex flex-column gap-1">
                                <input name="title[premium]" type="checkbox" class="check-input disabled_or_not" value="on" checked>
                                <input name="title[premium_price]" type="number" class="form-control price-input" placeholder="Extra price" min="0">
                                    ...
                                    <div class="package-field-price-flex flex-between">
                                        <div class="package-field-price-main">
                                            <h5 class="package-field-price-main-title">
                                                <span class="basic_regular_charge"><s>{{ float_amount_without_currency_symbol(50) }}</s></span>
                                                <span class="basic_discount_charge">{{ float_amount_without_currency_symbol(40) }}</span>
                                            </h5>
                                        </div>
                            ...
                            <div class="package-field">
                                <div class="package-field-price">
                                    <div class="package-field-price-flex flex-between">
                                        <div class="package-field-price-main">
                                            <h5 class="package-field-price-main-title">
                                                <span class="standard_regular_charge"><s>{{ float_amount_without_currency_symbol(60) }}</s></span>
                                                <span class="standard_discount_charge">{{ float_amount_without_currency_symbol(50) }}</span>
                                            </h5>
                                        </div>
                            ...
                            <div class="package-field">
                                <div class="package-field-price">
                                    <div class="package-field-price-flex flex-between">
                                        <div class="package-field-price-main">
                                            <h5 class="package-field-price-main-title">
                                                <span class="premium_regular_charge"><s>{{ float_amount_without_currency_symbol(70) }} </s></span>
                                                <span class="premium_discount_charge">{{ float_amount_without_currency_symbol(60) }}</span>
                                            </h5>
                                        </div>
    ...
    <div class="popup-contents">
        ...
        <div class="popup-contents-form custom-form">
            <div class="single-input single-input-icon">
                ...
                <input type="text" name="basic_regular_charge" id="basic_regular_charge" class="form--control" value="{!! float_amount_without_currency_symbol(50) !!}">
            ...
            <div class="single-input single-input-icon">
                ...
                <input type="text" name="basic_discount_charge" id="basic_discount_charge" class="form--control" value="{!! float_amount_without_currency_symbol(40) !!}">
                @if(moduleExists('CurrencySwitcher'))
                    <span class="input-icon">{{ site_currency_symbol() }}</span>
                @else
                    <span class="input-icon">{{ get_static_option('site_global_currency') ?? '' }}</span>
...
<div class="popup-fixed price-popup-standard-charge">
    <div class="popup-contents">
        ...
        <div class="popup-contents-form custom-form">
            <div class="single-input single-input-icon">
                <label class="label-title"> {{ __('Regular Charge') }} </label>
                <input type="text" name="standard_regular_charge" id="standard_regular_charge" class="form--control" value="{!! float_amount_without_currency_symbol(60) !!}">
                @if(moduleExists('CurrencySwitcher'))
                    <span class="input-icon">{{ site_currency_symbol() }}</span>
                @else
                    <span class="input-icon">{{ get_static_option('site_global_currency') ?? '' }}</span>
            ...
            <div class="single-input single-input-icon">
                <label class="label-title"> {{ __('Discount Charge(Optional)') }} </label>
                <input type="text" name="standard_discount_charge" id="standard_discount_charge" class="form--control" value="{!! float_amount_without_currency_symbol(50) !!}">
                @if(moduleExists('CurrencySwitcher'))
                    <span class="input-icon">{{ site_currency_symbol() }}</span>
                @else
                    <span class="input-icon">{{ get_static_option('site_global_currency') ?? '' }}</span>
...
<div class="popup-fixed price-popup-premium-charge">
    <div class="popup-contents">
        ...
        <div class="popup-contents-form custom-form">
            <div class="single-input single-input-icon">
                <label class="label-title">{{ __('Regular Charge') }}</label>
                <input type="text" name="premium_regular_charge" id="premium_regular_charge" class="form--control" value="{!! float_amount_without_currency_symbol(70) !!}">
                @if(moduleExists('CurrencySwitcher'))
                    <span class="input-icon">{{ site_currency_symbol() }}</span>
                @else
                    <span class="input-icon">{{ get_static_option('site_global_currency') ?? '' }}</span>
            ...
            <div class="single-input single-input-icon">
                <label class="label-title">{{ __('Discount Charge(Optional)') }}</label>
                <input type="text" name="premium_discount_charge" id="premium_discount_charge" class="form--control" value="{!! float_amount_without_currency_symbol(60) !!}">
                @if(moduleExists('CurrencySwitcher'))
                    <span class="input-icon">{{ site_currency_symbol() }}</span>
                @else
                    <span class="input-icon">{{ get_static_option('site_global_currency') ?? '' }}</span>
