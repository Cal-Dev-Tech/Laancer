<div class="shop-contents-wrapper-right">
    <div class="row g-4">
                        ...
                        <div class="categoryWrap-wrapper-item-top">
                            <div class="categoryWrap-wrapper-item-top-left">
                                ...
                                <p class="single-jobs-date">
                                    ...
                                    <span>{{ ucfirst(__($job->level)) ?? '' }}</span>
                                </p>
                            </div>
        ...
        @else
            <div class="col-lg-12">
                <div class="notFoundParent categoryWrap-wrapper-item text-center">
                    <div class="notFound-wrapper">
                        <div class="notFoundThumb">
                            <img src="{{ asset('assets/static/img/no-jobs-projects/no-job.svg') }}" alt="">
                        </div>
                        <div class="notFound-contents mt-3">
                            <h4 class="notFoundTitle">{{ __('No Jobs') }}</h4>
                            <p class="notFoundPara mt-3">{{ __("Sorry, We couldn't find any jobs in this category try checking on other categories") }}</p>
                        </div>
                    </div>
                </div>
            </div>
