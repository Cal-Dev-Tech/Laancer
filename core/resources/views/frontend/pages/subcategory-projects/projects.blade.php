...
@section('meta_title') {{ $subcategory->meta_title ?? $subcategory->sub_category ?? __('Subcategory Project')  }} @endsection
@section('meta_description') {{ $subcategory->meta_description ?? '' }} @endsection
