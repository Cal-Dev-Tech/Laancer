...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\TestMiddleware22::class,
    ];
    ...
    protected $routeMiddleware = [
        ...
        'projectAccess' => \App\Http\Middleware\CheckProjectAccess::class,
        'jobAccess' => \App\Http\Middleware\CheckJobpostAccess::class,
