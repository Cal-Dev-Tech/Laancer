...
use Modules\StripeConnect\App\Models\StripeAccount;
...
class User extends Authenticatable
{
    ...
    public function freelancer_subcategory()
    {
        return $this->hasMany(UserWork::class, 'user_id', 'id');
    }
    ...
    {
        return $this->stripeConnect?->isActive() ?? false;
    }
    ...
    public function canReceivePayouts(): bool
    {
        return $this->isFreelancer() &&
            $this->stripeConnect &&
            $this->stripeConnect->canReceivePayouts();
    }
}
