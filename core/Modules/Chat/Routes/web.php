...
//clients routes
Route::group(['prefix'=>'client/live','as'=>'client.','middleware'=>['auth','userEmailVerify','Google2FA','globalVariable', 'maintains_mode','setlang', 'identityVerified']],function() {
...
//freelancer routes
Route::group(['prefix'=>'freelancer/live','as'=>'freelancer.','middleware'=>['auth','userEmailVerify','Google2FA','globalVariable', 'maintains_mode','setlang', 'identityVerified']],function() {
